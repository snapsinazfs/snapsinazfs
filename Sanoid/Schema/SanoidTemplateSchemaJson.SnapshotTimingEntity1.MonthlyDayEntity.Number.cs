...
public readonly partial struct SanoidTemplateSchemaJson
{
    public readonly partial struct SnapshotTimingEntity1
    {
        ...
        /// </summary>
        public readonly partial struct MonthlyDayEntity : IJsonNumber<MonthlyDayEntity>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "MonthlyDayEntity"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public MonthlyDayEntity(double value)
            {
            ...
            public static implicit operator JsonNumber(MonthlyDayEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator MonthlyDayEntity(JsonNumber value)
            {
            ...
            public static implicit operator MonthlyDayEntity(double value)
            {
                return new(value);
            }
            ...
            public static implicit operator double (MonthlyDayEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator MonthlyDayEntity(float value)
            {
                return new(value);
            }
            ...
            public static implicit operator float (MonthlyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator MonthlyDayEntity(int value)
            {
                return new(value);
            }
            ...
            public static implicit operator int (MonthlyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator MonthlyDayEntity(long value)
            {
                return new(value);
            }
            ...
            public static implicit operator long (MonthlyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator MonthlyDayEntity(uint value)
            {
                return new(value);
            }
            ...
            public static implicit operator uint (MonthlyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator MonthlyDayEntity(ushort value)
            {
                return new(value);
            }
            ...
            public static implicit operator ushort (MonthlyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator MonthlyDayEntity(ulong value)
            {
                return new(value);
            }
            ...
            public static implicit operator ulong (MonthlyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator MonthlyDayEntity(byte value)
            {
                return new(value);
            }
            ...
            public static implicit operator byte (MonthlyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator MonthlyDayEntity(sbyte value)
            {
                return new(value);
            }
            ...
            public static implicit operator sbyte (MonthlyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
