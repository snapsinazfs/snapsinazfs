...
public readonly partial struct Schema
{
    public readonly partial struct FormattingEntity
    {
        public readonly partial struct SnapshotNamingEntity
        {
            ...
            /// </summary>
            public readonly partial struct HourlySuffixEntity : IJsonString<HourlySuffixEntity>
            {
                /// <summary>
                /// Initializes a new instance of the <see cref = "HourlySuffixEntity"/> struct.
                /// </summary>
                /// <param name = "value">The value from which to construct the instance.</param>
                public HourlySuffixEntity(string value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to construct the instance.</param>
                public HourlySuffixEntity(in ReadOnlySpan<char> value)
                {
                    this.jsonElementBacking = default;
                    this.backing = Backing.String;
                ...
                public HourlySuffixEntity(in ReadOnlySpan<byte> utf8Value)
                {
                    this.jsonElementBacking = default;
                    this.backing = Backing.String;
                ...
                public static implicit operator JsonString(HourlySuffixEntity value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator HourlySuffixEntity(JsonString value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator HourlySuffixEntity(string value)
                {
                    return new(value);
                }
                ...
                public static implicit operator string (HourlySuffixEntity value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator HourlySuffixEntity(ReadOnlySpan<char> value)
                {
                    return new(value);
                }
                ...
                /// <param name = "value">The value from which to convert.</param>
                /// <exception cref = "InvalidOperationException">The value was not a string.</exception>
                public static implicit operator ReadOnlySpan<char>(HourlySuffixEntity value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator HourlySuffixEntity(ReadOnlySpan<byte> value)
                {
                    return new(value);
                }
