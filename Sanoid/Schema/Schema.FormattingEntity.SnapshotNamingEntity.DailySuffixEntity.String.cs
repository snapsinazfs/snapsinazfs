...
public readonly partial struct Schema
{
    public readonly partial struct FormattingEntity
    {
        public readonly partial struct SnapshotNamingEntity
        {
            ...
            /// </summary>
            public readonly partial struct DailySuffixEntity : IJsonString<DailySuffixEntity>
            {
                /// <summary>
                /// Initializes a new instance of the <see cref = "DailySuffixEntity"/> struct.
                /// </summary>
                /// <param name = "value">The value from which to construct the instance.</param>
                public DailySuffixEntity(string value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to construct the instance.</param>
                public DailySuffixEntity(in ReadOnlySpan<char> value)
                {
                    this.jsonElementBacking = default;
                    this.backing = Backing.String;
                ...
                public DailySuffixEntity(in ReadOnlySpan<byte> utf8Value)
                {
                    this.jsonElementBacking = default;
                    this.backing = Backing.String;
                ...
                public static implicit operator JsonString(DailySuffixEntity value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator DailySuffixEntity(JsonString value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator DailySuffixEntity(string value)
                {
                    return new(value);
                }
                ...
                public static implicit operator string (DailySuffixEntity value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator DailySuffixEntity(ReadOnlySpan<char> value)
                {
                    return new(value);
                }
                ...
                /// <param name = "value">The value from which to convert.</param>
                /// <exception cref = "InvalidOperationException">The value was not a string.</exception>
                public static implicit operator ReadOnlySpan<char>(DailySuffixEntity value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator DailySuffixEntity(ReadOnlySpan<byte> value)
                {
                    return new(value);
                }
