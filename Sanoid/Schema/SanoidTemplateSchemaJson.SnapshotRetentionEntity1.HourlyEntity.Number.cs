...
public readonly partial struct SanoidTemplateSchemaJson
{
    public readonly partial struct SnapshotRetentionEntity1
    {
        ...
        /// </summary>
        public readonly partial struct HourlyEntity : IJsonNumber<HourlyEntity>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "HourlyEntity"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public HourlyEntity(double value)
            {
            ...
            public static implicit operator JsonNumber(HourlyEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator HourlyEntity(JsonNumber value)
            {
            ...
            public static implicit operator HourlyEntity(double value)
            {
                return new(value);
            }
            ...
            public static implicit operator double (HourlyEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator HourlyEntity(float value)
            {
                return new(value);
            }
            ...
            public static implicit operator float (HourlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator HourlyEntity(int value)
            {
                return new(value);
            }
            ...
            public static implicit operator int (HourlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator HourlyEntity(long value)
            {
                return new(value);
            }
            ...
            public static implicit operator long (HourlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator HourlyEntity(uint value)
            {
                return new(value);
            }
            ...
            public static implicit operator uint (HourlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator HourlyEntity(ushort value)
            {
                return new(value);
            }
            ...
            public static implicit operator ushort (HourlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator HourlyEntity(ulong value)
            {
                return new(value);
            }
            ...
            public static implicit operator ulong (HourlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator HourlyEntity(byte value)
            {
                return new(value);
            }
            ...
            public static implicit operator byte (HourlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator HourlyEntity(sbyte value)
            {
                return new(value);
            }
            ...
            public static implicit operator sbyte (HourlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
