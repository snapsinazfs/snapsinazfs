...
public readonly partial struct Schema
{
    ...
    /// </summary>
    public readonly partial struct SanoidConfigurationLocalFileEntity : IJsonString<SanoidConfigurationLocalFileEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "SanoidConfigurationLocalFileEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public SanoidConfigurationLocalFileEntity(string value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public SanoidConfigurationLocalFileEntity(in ReadOnlySpan<char> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.String;
        ...
        public SanoidConfigurationLocalFileEntity(in ReadOnlySpan<byte> utf8Value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.String;
        ...
        public static implicit operator JsonString(SanoidConfigurationLocalFileEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SanoidConfigurationLocalFileEntity(JsonString value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SanoidConfigurationLocalFileEntity(string value)
        {
            return new(value);
        }
        ...
        public static implicit operator string (SanoidConfigurationLocalFileEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SanoidConfigurationLocalFileEntity(ReadOnlySpan<char> value)
        {
            return new(value);
        }
        ...
        /// <param name = "value">The value from which to convert.</param>
        /// <exception cref = "InvalidOperationException">The value was not a string.</exception>
        public static implicit operator ReadOnlySpan<char>(SanoidConfigurationLocalFileEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SanoidConfigurationLocalFileEntity(ReadOnlySpan<byte> value)
        {
            return new(value);
        }
