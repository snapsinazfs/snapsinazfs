...
public readonly partial struct SanoidTemplateSchemaJson
{
    public readonly partial struct SnapshotTimingEntity1
    {
        ...
        /// </summary>
        public readonly partial struct WeeklyDayEntity : IJsonNumber<WeeklyDayEntity>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "WeeklyDayEntity"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public WeeklyDayEntity(double value)
            {
            ...
            public static implicit operator JsonNumber(WeeklyDayEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator WeeklyDayEntity(JsonNumber value)
            {
            ...
            public static implicit operator WeeklyDayEntity(double value)
            {
                return new(value);
            }
            ...
            public static implicit operator double (WeeklyDayEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator WeeklyDayEntity(float value)
            {
                return new(value);
            }
            ...
            public static implicit operator float (WeeklyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator WeeklyDayEntity(int value)
            {
                return new(value);
            }
            ...
            public static implicit operator int (WeeklyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator WeeklyDayEntity(long value)
            {
                return new(value);
            }
            ...
            public static implicit operator long (WeeklyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator WeeklyDayEntity(uint value)
            {
                return new(value);
            }
            ...
            public static implicit operator uint (WeeklyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator WeeklyDayEntity(ushort value)
            {
                return new(value);
            }
            ...
            public static implicit operator ushort (WeeklyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator WeeklyDayEntity(ulong value)
            {
                return new(value);
            }
            ...
            public static implicit operator ulong (WeeklyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator WeeklyDayEntity(byte value)
            {
                return new(value);
            }
            ...
            public static implicit operator byte (WeeklyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator WeeklyDayEntity(sbyte value)
            {
                return new(value);
            }
            ...
            public static implicit operator sbyte (WeeklyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
