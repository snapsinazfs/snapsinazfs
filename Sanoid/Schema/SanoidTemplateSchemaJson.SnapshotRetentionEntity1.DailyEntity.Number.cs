...
public readonly partial struct SanoidTemplateSchemaJson
{
    public readonly partial struct SnapshotRetentionEntity1
    {
        ...
        /// </summary>
        public readonly partial struct DailyEntity : IJsonNumber<DailyEntity>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "DailyEntity"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public DailyEntity(double value)
            {
            ...
            public static implicit operator JsonNumber(DailyEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator DailyEntity(JsonNumber value)
            {
            ...
            public static implicit operator DailyEntity(double value)
            {
                return new(value);
            }
            ...
            public static implicit operator double (DailyEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator DailyEntity(float value)
            {
                return new(value);
            }
            ...
            public static implicit operator float (DailyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator DailyEntity(int value)
            {
                return new(value);
            }
            ...
            public static implicit operator int (DailyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator DailyEntity(long value)
            {
                return new(value);
            }
            ...
            public static implicit operator long (DailyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator DailyEntity(uint value)
            {
                return new(value);
            }
            ...
            public static implicit operator uint (DailyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator DailyEntity(ushort value)
            {
                return new(value);
            }
            ...
            public static implicit operator ushort (DailyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator DailyEntity(ulong value)
            {
                return new(value);
            }
            ...
            public static implicit operator ulong (DailyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator DailyEntity(byte value)
            {
                return new(value);
            }
            ...
            public static implicit operator byte (DailyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator DailyEntity(sbyte value)
            {
                return new(value);
            }
            ...
            public static implicit operator sbyte (DailyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
