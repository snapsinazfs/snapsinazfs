...
public readonly partial struct Schema
{
    ...
    /// </summary>
    public readonly partial struct SanoidConfigurationPathBaseEntity : IJsonString<SanoidConfigurationPathBaseEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "SanoidConfigurationPathBaseEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public SanoidConfigurationPathBaseEntity(string value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public SanoidConfigurationPathBaseEntity(in ReadOnlySpan<char> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.String;
        ...
        public SanoidConfigurationPathBaseEntity(in ReadOnlySpan<byte> utf8Value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.String;
        ...
        public static implicit operator JsonString(SanoidConfigurationPathBaseEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SanoidConfigurationPathBaseEntity(JsonString value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SanoidConfigurationPathBaseEntity(string value)
        {
            return new(value);
        }
        ...
        public static implicit operator string (SanoidConfigurationPathBaseEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SanoidConfigurationPathBaseEntity(ReadOnlySpan<char> value)
        {
            return new(value);
        }
        ...
        /// <param name = "value">The value from which to convert.</param>
        /// <exception cref = "InvalidOperationException">The value was not a string.</exception>
        public static implicit operator ReadOnlySpan<char>(SanoidConfigurationPathBaseEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SanoidConfigurationPathBaseEntity(ReadOnlySpan<byte> value)
        {
            return new(value);
        }
