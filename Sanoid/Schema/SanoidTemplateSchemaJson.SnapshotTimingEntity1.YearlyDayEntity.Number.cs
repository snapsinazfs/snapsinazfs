...
public readonly partial struct SanoidTemplateSchemaJson
{
    public readonly partial struct SnapshotTimingEntity1
    {
        ...
        /// </summary>
        public readonly partial struct YearlyDayEntity : IJsonNumber<YearlyDayEntity>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "YearlyDayEntity"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public YearlyDayEntity(double value)
            {
            ...
            public static implicit operator JsonNumber(YearlyDayEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator YearlyDayEntity(JsonNumber value)
            {
            ...
            public static implicit operator YearlyDayEntity(double value)
            {
                return new(value);
            }
            ...
            public static implicit operator double (YearlyDayEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyDayEntity(float value)
            {
                return new(value);
            }
            ...
            public static implicit operator float (YearlyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyDayEntity(int value)
            {
                return new(value);
            }
            ...
            public static implicit operator int (YearlyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyDayEntity(long value)
            {
                return new(value);
            }
            ...
            public static implicit operator long (YearlyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator YearlyDayEntity(uint value)
            {
                return new(value);
            }
            ...
            public static implicit operator uint (YearlyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyDayEntity(ushort value)
            {
                return new(value);
            }
            ...
            public static implicit operator ushort (YearlyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyDayEntity(ulong value)
            {
                return new(value);
            }
            ...
            public static implicit operator ulong (YearlyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyDayEntity(byte value)
            {
                return new(value);
            }
            ...
            public static implicit operator byte (YearlyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyDayEntity(sbyte value)
            {
                return new(value);
            }
            ...
            public static implicit operator sbyte (YearlyDayEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
