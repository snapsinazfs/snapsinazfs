...
public readonly partial struct SanoidTemplateSchemaJson
{
    public readonly partial struct SnapshotRetentionEntity1
    {
        ...
        /// </summary>
        public readonly partial struct WeeklyEntity : IJsonNumber<WeeklyEntity>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "WeeklyEntity"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public WeeklyEntity(double value)
            {
            ...
            public static implicit operator JsonNumber(WeeklyEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator WeeklyEntity(JsonNumber value)
            {
            ...
            public static implicit operator WeeklyEntity(double value)
            {
                return new(value);
            }
            ...
            public static implicit operator double (WeeklyEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator WeeklyEntity(float value)
            {
                return new(value);
            }
            ...
            public static implicit operator float (WeeklyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator WeeklyEntity(int value)
            {
                return new(value);
            }
            ...
            public static implicit operator int (WeeklyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator WeeklyEntity(long value)
            {
                return new(value);
            }
            ...
            public static implicit operator long (WeeklyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator WeeklyEntity(uint value)
            {
                return new(value);
            }
            ...
            public static implicit operator uint (WeeklyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator WeeklyEntity(ushort value)
            {
                return new(value);
            }
            ...
            public static implicit operator ushort (WeeklyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator WeeklyEntity(ulong value)
            {
                return new(value);
            }
            ...
            public static implicit operator ulong (WeeklyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator WeeklyEntity(byte value)
            {
                return new(value);
            }
            ...
            public static implicit operator byte (WeeklyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator WeeklyEntity(sbyte value)
            {
                return new(value);
            }
            ...
            public static implicit operator sbyte (WeeklyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
