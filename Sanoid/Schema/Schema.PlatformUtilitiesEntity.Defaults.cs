...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PlatformUtilitiesEntity
    {
        ...
        private static ImmutableDictionary<JsonPropertyName, JsonAny> BuildDefaults()
        {
            ...
            builder.Add(PsJsonPropertyName, JsonAny.Parse("\"/usr/bin/ps\""));
            builder.Add(ZfsJsonPropertyName, JsonAny.Parse("\"/usr/local/sbin/zfs\""));
            builder.Add(ZpoolJsonPropertyName, JsonAny.Parse("\"/usr/local/sbin/zpool\""));
