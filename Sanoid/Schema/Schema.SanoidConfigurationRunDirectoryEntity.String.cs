...
public readonly partial struct Schema
{
    ...
    /// </summary>
    public readonly partial struct SanoidConfigurationRunDirectoryEntity : IJsonString<SanoidConfigurationRunDirectoryEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "SanoidConfigurationRunDirectoryEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public SanoidConfigurationRunDirectoryEntity(string value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public SanoidConfigurationRunDirectoryEntity(in ReadOnlySpan<char> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.String;
        ...
        public SanoidConfigurationRunDirectoryEntity(in ReadOnlySpan<byte> utf8Value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.String;
        ...
        public static implicit operator JsonString(SanoidConfigurationRunDirectoryEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SanoidConfigurationRunDirectoryEntity(JsonString value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SanoidConfigurationRunDirectoryEntity(string value)
        {
            return new(value);
        }
        ...
        public static implicit operator string (SanoidConfigurationRunDirectoryEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SanoidConfigurationRunDirectoryEntity(ReadOnlySpan<char> value)
        {
            return new(value);
        }
        ...
        /// <param name = "value">The value from which to convert.</param>
        /// <exception cref = "InvalidOperationException">The value was not a string.</exception>
        public static implicit operator ReadOnlySpan<char>(SanoidConfigurationRunDirectoryEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SanoidConfigurationRunDirectoryEntity(ReadOnlySpan<byte> value)
        {
            return new(value);
        }
