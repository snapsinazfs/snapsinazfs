...
public readonly partial struct SanoidTemplateSchemaJson
{
    public readonly partial struct SnapshotRetentionEntity1
    {
        ...
        /// </summary>
        public readonly partial struct PruneDeferralEntity : IJsonNumber<PruneDeferralEntity>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "PruneDeferralEntity"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public PruneDeferralEntity(double value)
            {
            ...
            public static implicit operator JsonNumber(PruneDeferralEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator PruneDeferralEntity(JsonNumber value)
            {
            ...
            public static implicit operator PruneDeferralEntity(double value)
            {
                return new(value);
            }
            ...
            public static implicit operator double (PruneDeferralEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator PruneDeferralEntity(float value)
            {
                return new(value);
            }
            ...
            public static implicit operator float (PruneDeferralEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator PruneDeferralEntity(int value)
            {
                return new(value);
            }
            ...
            public static implicit operator int (PruneDeferralEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator PruneDeferralEntity(long value)
            {
                return new(value);
            }
            ...
            public static implicit operator long (PruneDeferralEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator PruneDeferralEntity(uint value)
            {
                return new(value);
            }
            ...
            public static implicit operator uint (PruneDeferralEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator PruneDeferralEntity(ushort value)
            {
                return new(value);
            }
            ...
            public static implicit operator ushort (PruneDeferralEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator PruneDeferralEntity(ulong value)
            {
                return new(value);
            }
            ...
            public static implicit operator ulong (PruneDeferralEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator PruneDeferralEntity(byte value)
            {
                return new(value);
            }
            ...
            public static implicit operator byte (PruneDeferralEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator PruneDeferralEntity(sbyte value)
            {
                return new(value);
            }
            ...
            public static implicit operator sbyte (PruneDeferralEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
