...
public readonly partial struct Schema
{
    public readonly partial struct FormattingEntity
    {
        public readonly partial struct SnapshotNamingEntity
        {
            ...
            /// </summary>
            public readonly partial struct MonthlySuffixEntity : IJsonString<MonthlySuffixEntity>
            {
                /// <summary>
                /// Initializes a new instance of the <see cref = "MonthlySuffixEntity"/> struct.
                /// </summary>
                /// <param name = "value">The value from which to construct the instance.</param>
                public MonthlySuffixEntity(string value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to construct the instance.</param>
                public MonthlySuffixEntity(in ReadOnlySpan<char> value)
                {
                    this.jsonElementBacking = default;
                    this.backing = Backing.String;
                ...
                public MonthlySuffixEntity(in ReadOnlySpan<byte> utf8Value)
                {
                    this.jsonElementBacking = default;
                    this.backing = Backing.String;
                ...
                public static implicit operator JsonString(MonthlySuffixEntity value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator MonthlySuffixEntity(JsonString value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator MonthlySuffixEntity(string value)
                {
                    return new(value);
                }
                ...
                public static implicit operator string (MonthlySuffixEntity value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator MonthlySuffixEntity(ReadOnlySpan<char> value)
                {
                    return new(value);
                }
                ...
                /// <param name = "value">The value from which to convert.</param>
                /// <exception cref = "InvalidOperationException">The value was not a string.</exception>
                public static implicit operator ReadOnlySpan<char>(MonthlySuffixEntity value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator MonthlySuffixEntity(ReadOnlySpan<byte> value)
                {
                    return new(value);
                }
