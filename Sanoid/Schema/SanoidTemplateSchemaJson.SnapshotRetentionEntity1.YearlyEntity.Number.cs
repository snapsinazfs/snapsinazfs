...
public readonly partial struct SanoidTemplateSchemaJson
{
    public readonly partial struct SnapshotRetentionEntity1
    {
        ...
        /// </summary>
        public readonly partial struct YearlyEntity : IJsonNumber<YearlyEntity>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "YearlyEntity"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public YearlyEntity(double value)
            {
            ...
            public static implicit operator JsonNumber(YearlyEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator YearlyEntity(JsonNumber value)
            {
            ...
            public static implicit operator YearlyEntity(double value)
            {
                return new(value);
            }
            ...
            public static implicit operator double (YearlyEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyEntity(float value)
            {
                return new(value);
            }
            ...
            public static implicit operator float (YearlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyEntity(int value)
            {
                return new(value);
            }
            ...
            public static implicit operator int (YearlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyEntity(long value)
            {
                return new(value);
            }
            ...
            public static implicit operator long (YearlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator YearlyEntity(uint value)
            {
                return new(value);
            }
            ...
            public static implicit operator uint (YearlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyEntity(ushort value)
            {
                return new(value);
            }
            ...
            public static implicit operator ushort (YearlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyEntity(ulong value)
            {
                return new(value);
            }
            ...
            public static implicit operator ulong (YearlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyEntity(byte value)
            {
                return new(value);
            }
            ...
            public static implicit operator byte (YearlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyEntity(sbyte value)
            {
                return new(value);
            }
            ...
            public static implicit operator sbyte (YearlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
