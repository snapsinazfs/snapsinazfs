    ...
    public readonly partial struct FormattingEntity
    {
        ...
        public readonly partial struct SnapshotNamingEntity
        {
            ...
            private static ImmutableDictionary<JsonPropertyName, JsonAny> BuildDefaults()
            {
                ...
                builder.Add(ComponentSeparatorJsonPropertyName, JsonAny.Parse("\"_\""));
                builder.Add(PrefixJsonPropertyName, JsonAny.Parse("\"autosnap\""));
                builder.Add(TimestampFormatStringJsonPropertyName, JsonAny.Parse("\"yyyy-MM-dd_HH\\\\:mm\\\\:ss\""));
                builder.Add(FrequentSuffixJsonPropertyName, JsonAny.Parse("\"frequently\""));
                builder.Add(HourlySuffixJsonPropertyName, JsonAny.Parse("\"hourly\""));
                builder.Add(DailySuffixJsonPropertyName, JsonAny.Parse("\"daily\""));
                builder.Add(WeeklySuffixJsonPropertyName, JsonAny.Parse("\"weekly\""));
                builder.Add(MonthlySuffixJsonPropertyName, JsonAny.Parse("\"monthly\""));
                builder.Add(YearlySuffixJsonPropertyName, JsonAny.Parse("\"yearly\""));
