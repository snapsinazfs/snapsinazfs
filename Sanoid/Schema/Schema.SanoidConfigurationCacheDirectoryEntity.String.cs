...
public readonly partial struct Schema
{
    ...
    /// </summary>
    public readonly partial struct SanoidConfigurationCacheDirectoryEntity : IJsonString<SanoidConfigurationCacheDirectoryEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "SanoidConfigurationCacheDirectoryEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public SanoidConfigurationCacheDirectoryEntity(string value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public SanoidConfigurationCacheDirectoryEntity(in ReadOnlySpan<char> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.String;
        ...
        public SanoidConfigurationCacheDirectoryEntity(in ReadOnlySpan<byte> utf8Value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.String;
        ...
        public static implicit operator JsonString(SanoidConfigurationCacheDirectoryEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SanoidConfigurationCacheDirectoryEntity(JsonString value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SanoidConfigurationCacheDirectoryEntity(string value)
        {
            return new(value);
        }
        ...
        public static implicit operator string (SanoidConfigurationCacheDirectoryEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SanoidConfigurationCacheDirectoryEntity(ReadOnlySpan<char> value)
        {
            return new(value);
        }
        ...
        /// <param name = "value">The value from which to convert.</param>
        /// <exception cref = "InvalidOperationException">The value was not a string.</exception>
        public static implicit operator ReadOnlySpan<char>(SanoidConfigurationCacheDirectoryEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SanoidConfigurationCacheDirectoryEntity(ReadOnlySpan<byte> value)
        {
            return new(value);
        }
