    ...
    public readonly partial struct MonitoringEntity
    {
        ...
        public readonly partial struct AdditionalPropertiesEntity
        {
            ...
            private static ImmutableDictionary<JsonPropertyName, JsonAny> BuildDefaults()
            {
                ...
                builder.Add(HealthJsonPropertyName, JsonAny.Parse("false"));
                builder.Add(CapacityJsonPropertyName, JsonAny.Parse("false"));
                builder.Add(SnapshotsJsonPropertyName, JsonAny.Parse("false"));
