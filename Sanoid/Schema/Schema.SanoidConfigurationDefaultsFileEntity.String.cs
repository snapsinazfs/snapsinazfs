...
public readonly partial struct Schema
{
    ...
    /// </summary>
    public readonly partial struct SanoidConfigurationDefaultsFileEntity : IJsonString<SanoidConfigurationDefaultsFileEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "SanoidConfigurationDefaultsFileEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public SanoidConfigurationDefaultsFileEntity(string value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public SanoidConfigurationDefaultsFileEntity(in ReadOnlySpan<char> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.String;
        ...
        public SanoidConfigurationDefaultsFileEntity(in ReadOnlySpan<byte> utf8Value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.String;
        ...
        public static implicit operator JsonString(SanoidConfigurationDefaultsFileEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SanoidConfigurationDefaultsFileEntity(JsonString value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SanoidConfigurationDefaultsFileEntity(string value)
        {
            return new(value);
        }
        ...
        public static implicit operator string (SanoidConfigurationDefaultsFileEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SanoidConfigurationDefaultsFileEntity(ReadOnlySpan<char> value)
        {
            return new(value);
        }
        ...
        /// <param name = "value">The value from which to convert.</param>
        /// <exception cref = "InvalidOperationException">The value was not a string.</exception>
        public static implicit operator ReadOnlySpan<char>(SanoidConfigurationDefaultsFileEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SanoidConfigurationDefaultsFileEntity(ReadOnlySpan<byte> value)
        {
            return new(value);
        }
