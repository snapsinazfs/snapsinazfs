...
public readonly partial struct SanoidTemplateSchemaJson
{
    ...
    public readonly partial struct SnapshotRetentionEntity
    {
        private ValidationContext ValidateRef(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext refResult = this.As<Sanoid.Schema.SanoidTemplateSchemaJson.SnapshotRetentionEntity1>().Validate(validationContext.CreateChildContext(), level);
