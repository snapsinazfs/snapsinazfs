...
public readonly partial struct SanoidTemplateSchemaJson
{
    public readonly partial struct SnapshotTimingEntity1
    {
        ...
        /// </summary>
        public readonly partial struct YearlyMonthEntity : IJsonNumber<YearlyMonthEntity>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "YearlyMonthEntity"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public YearlyMonthEntity(double value)
            {
            ...
            public static implicit operator JsonNumber(YearlyMonthEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator YearlyMonthEntity(JsonNumber value)
            {
            ...
            public static implicit operator YearlyMonthEntity(double value)
            {
                return new(value);
            }
            ...
            public static implicit operator double (YearlyMonthEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyMonthEntity(float value)
            {
                return new(value);
            }
            ...
            public static implicit operator float (YearlyMonthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyMonthEntity(int value)
            {
                return new(value);
            }
            ...
            public static implicit operator int (YearlyMonthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyMonthEntity(long value)
            {
                return new(value);
            }
            ...
            public static implicit operator long (YearlyMonthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator YearlyMonthEntity(uint value)
            {
                return new(value);
            }
            ...
            public static implicit operator uint (YearlyMonthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyMonthEntity(ushort value)
            {
                return new(value);
            }
            ...
            public static implicit operator ushort (YearlyMonthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyMonthEntity(ulong value)
            {
                return new(value);
            }
            ...
            public static implicit operator ulong (YearlyMonthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyMonthEntity(byte value)
            {
                return new(value);
            }
            ...
            public static implicit operator byte (YearlyMonthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator YearlyMonthEntity(sbyte value)
            {
                return new(value);
            }
            ...
            public static implicit operator sbyte (YearlyMonthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
