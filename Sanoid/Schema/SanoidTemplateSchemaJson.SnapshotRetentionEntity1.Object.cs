...
public readonly partial struct SanoidTemplateSchemaJson
{
    ...
    /// </summary>
    public readonly partial struct SnapshotRetentionEntity1 : IJsonObject<SnapshotRetentionEntity1>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "SnapshotRetentionEntity1"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public SnapshotRetentionEntity1(ImmutableDictionary<JsonPropertyName, JsonAny> value)
        {
        ...
        public static implicit operator JsonObject(SnapshotRetentionEntity1 value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SnapshotRetentionEntity1(JsonObject value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SnapshotRetentionEntity1(ImmutableDictionary<JsonPropertyName, JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableDictionary<JsonPropertyName, JsonAny>(SnapshotRetentionEntity1 value)
        {
        ...
        public static SnapshotRetentionEntity1 FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static SnapshotRetentionEntity1 FromProperties(ImmutableDictionary<JsonPropertyName, JsonAny> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static SnapshotRetentionEntity1 FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public SnapshotRetentionEntity1 SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public SnapshotRetentionEntity1 SetProperty<TValue>(string name, TValue value)
            where TValue : struct, IJsonValue
        {
            return new(this.GetImmutableDictionaryWith(name, value.AsAny));
        }
        ...
        /// <inheritdoc/>
        public SnapshotRetentionEntity1 SetProperty<TValue>(ReadOnlySpan<char> name, TValue value)
            where TValue : struct, IJsonValue
        {
            return new(this.GetImmutableDictionaryWith(name, value.AsAny));
        }
        ...
        /// <inheritdoc/>
        public SnapshotRetentionEntity1 SetProperty<TValue>(ReadOnlySpan<byte> utf8Name, TValue value)
            where TValue : struct, IJsonValue
        {
        ...
        /// <inheritdoc/>
        public SnapshotRetentionEntity1 RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetImmutableDictionaryWithout(name));
        }

        /// <inheritdoc/>
        public SnapshotRetentionEntity1 RemoveProperty(string name)
        {
            return new(this.GetImmutableDictionaryWithout(name));
        }

        /// <inheritdoc/>
        public SnapshotRetentionEntity1 RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetImmutableDictionaryWithout(name));
        }

        /// <inheritdoc/>
        public SnapshotRetentionEntity1 RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
