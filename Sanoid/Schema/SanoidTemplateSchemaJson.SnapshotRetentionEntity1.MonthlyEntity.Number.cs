...
public readonly partial struct SanoidTemplateSchemaJson
{
    public readonly partial struct SnapshotRetentionEntity1
    {
        ...
        /// </summary>
        public readonly partial struct MonthlyEntity : IJsonNumber<MonthlyEntity>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "MonthlyEntity"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public MonthlyEntity(double value)
            {
            ...
            public static implicit operator JsonNumber(MonthlyEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator MonthlyEntity(JsonNumber value)
            {
            ...
            public static implicit operator MonthlyEntity(double value)
            {
                return new(value);
            }
            ...
            public static implicit operator double (MonthlyEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator MonthlyEntity(float value)
            {
                return new(value);
            }
            ...
            public static implicit operator float (MonthlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator MonthlyEntity(int value)
            {
                return new(value);
            }
            ...
            public static implicit operator int (MonthlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator MonthlyEntity(long value)
            {
                return new(value);
            }
            ...
            public static implicit operator long (MonthlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator MonthlyEntity(uint value)
            {
                return new(value);
            }
            ...
            public static implicit operator uint (MonthlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator MonthlyEntity(ushort value)
            {
                return new(value);
            }
            ...
            public static implicit operator ushort (MonthlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator MonthlyEntity(ulong value)
            {
                return new(value);
            }
            ...
            public static implicit operator ulong (MonthlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator MonthlyEntity(byte value)
            {
                return new(value);
            }
            ...
            public static implicit operator byte (MonthlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator MonthlyEntity(sbyte value)
            {
                return new(value);
            }
            ...
            public static implicit operator sbyte (MonthlyEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
