...
public readonly partial struct Schema
{
    public readonly partial struct FormattingEntity
    {
        public readonly partial struct SnapshotNamingEntity
        {
            ...
            /// </summary>
            public readonly partial struct WeeklySuffixEntity : IJsonString<WeeklySuffixEntity>
            {
                /// <summary>
                /// Initializes a new instance of the <see cref = "WeeklySuffixEntity"/> struct.
                /// </summary>
                /// <param name = "value">The value from which to construct the instance.</param>
                public WeeklySuffixEntity(string value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to construct the instance.</param>
                public WeeklySuffixEntity(in ReadOnlySpan<char> value)
                {
                    this.jsonElementBacking = default;
                    this.backing = Backing.String;
                ...
                public WeeklySuffixEntity(in ReadOnlySpan<byte> utf8Value)
                {
                    this.jsonElementBacking = default;
                    this.backing = Backing.String;
                ...
                public static implicit operator JsonString(WeeklySuffixEntity value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator WeeklySuffixEntity(JsonString value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator WeeklySuffixEntity(string value)
                {
                    return new(value);
                }
                ...
                public static implicit operator string (WeeklySuffixEntity value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator WeeklySuffixEntity(ReadOnlySpan<char> value)
                {
                    return new(value);
                }
                ...
                /// <param name = "value">The value from which to convert.</param>
                /// <exception cref = "InvalidOperationException">The value was not a string.</exception>
                public static implicit operator ReadOnlySpan<char>(WeeklySuffixEntity value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator WeeklySuffixEntity(ReadOnlySpan<byte> value)
                {
                    return new(value);
                }
