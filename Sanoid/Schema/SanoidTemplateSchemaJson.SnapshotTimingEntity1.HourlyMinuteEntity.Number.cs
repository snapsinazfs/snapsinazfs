...
public readonly partial struct SanoidTemplateSchemaJson
{
    public readonly partial struct SnapshotTimingEntity1
    {
        ...
        /// </summary>
        public readonly partial struct HourlyMinuteEntity : IJsonNumber<HourlyMinuteEntity>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "HourlyMinuteEntity"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public HourlyMinuteEntity(double value)
            {
            ...
            public static implicit operator JsonNumber(HourlyMinuteEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator HourlyMinuteEntity(JsonNumber value)
            {
            ...
            public static implicit operator HourlyMinuteEntity(double value)
            {
                return new(value);
            }
            ...
            public static implicit operator double (HourlyMinuteEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator HourlyMinuteEntity(float value)
            {
                return new(value);
            }
            ...
            public static implicit operator float (HourlyMinuteEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator HourlyMinuteEntity(int value)
            {
                return new(value);
            }
            ...
            public static implicit operator int (HourlyMinuteEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator HourlyMinuteEntity(long value)
            {
                return new(value);
            }
            ...
            public static implicit operator long (HourlyMinuteEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator HourlyMinuteEntity(uint value)
            {
                return new(value);
            }
            ...
            public static implicit operator uint (HourlyMinuteEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator HourlyMinuteEntity(ushort value)
            {
                return new(value);
            }
            ...
            public static implicit operator ushort (HourlyMinuteEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator HourlyMinuteEntity(ulong value)
            {
                return new(value);
            }
            ...
            public static implicit operator ulong (HourlyMinuteEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator HourlyMinuteEntity(byte value)
            {
                return new(value);
            }
            ...
            public static implicit operator byte (HourlyMinuteEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator HourlyMinuteEntity(sbyte value)
            {
                return new(value);
            }
            ...
            public static implicit operator sbyte (HourlyMinuteEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
