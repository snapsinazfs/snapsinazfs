...
public readonly partial struct SanoidTemplateSchemaJson
{
    public readonly partial struct SnapshotRetentionEntity1
    {
        ...
        /// </summary>
        public readonly partial struct FrequentEntity : IJsonNumber<FrequentEntity>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "FrequentEntity"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public FrequentEntity(double value)
            {
            ...
            public static implicit operator JsonNumber(FrequentEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator FrequentEntity(JsonNumber value)
            {
            ...
            public static implicit operator FrequentEntity(double value)
            {
                return new(value);
            }
            ...
            public static implicit operator double (FrequentEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator FrequentEntity(float value)
            {
                return new(value);
            }
            ...
            public static implicit operator float (FrequentEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator FrequentEntity(int value)
            {
                return new(value);
            }
            ...
            public static implicit operator int (FrequentEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator FrequentEntity(long value)
            {
                return new(value);
            }
            ...
            public static implicit operator long (FrequentEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator FrequentEntity(uint value)
            {
                return new(value);
            }
            ...
            public static implicit operator uint (FrequentEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator FrequentEntity(ushort value)
            {
                return new(value);
            }
            ...
            public static implicit operator ushort (FrequentEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator FrequentEntity(ulong value)
            {
                return new(value);
            }
            ...
            public static implicit operator ulong (FrequentEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator FrequentEntity(byte value)
            {
                return new(value);
            }
            ...
            public static implicit operator byte (FrequentEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static implicit operator FrequentEntity(sbyte value)
            {
                return new(value);
            }
            ...
            public static implicit operator sbyte (FrequentEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
