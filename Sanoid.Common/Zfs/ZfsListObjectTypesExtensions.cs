...
/// <summary>
///     Extension methods to simplify common operations of the <see cref="ZfsListObjectTypes" /> <see langword="enum" />
/// </summary>
public static class ZfsListObjectTypesExtensions
{
    ...
    /// </summary>
    /// <param name="value">The <see cref="ZfsListObjectTypes" /> value to convert</param>
    /// <returns>
    ...
    /// </returns>
    public static string[] ToStringArray( this ZfsListObjectTypes value )
    {
