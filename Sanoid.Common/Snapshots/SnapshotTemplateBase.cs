...
public abstract class SnapshotTemplateBase
{
    ...
    /// </summary>
    /// <value>A <see langword="string"/> value that corresponds to a template's name, which are represented as sections in ini configuration files.</value>
    ...
    /// </summary>
    /// <value>A <see langword="bool"/> value indicating whether this template applies to the <see cref="Path">Path</see> (<see langword="false"/>) or only to its children (<see langword="true"/>)</value>
    public bool ProcessChildrenOnly { get; set; }

    /// <summary>
    /// Gets or sets whether this template skips children
    /// </summary>
    /// <value>A <see langword="bool"/> value indicating whether this template skips children of the <see cref="Path">Path</see> (<see langword="true"/>) or not (<see langword="false"/>)</value>
