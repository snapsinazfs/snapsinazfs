...
public class TemplateTests
{
    ...
    public void CanCreateDefaultTemplate( )
    {
        ...
        bool insertedDefaultTemplate = _templatesDictionary.TryAdd( _defaultTemplate.Name, _defaultTemplate );

        Assert.Multiple( ( ) =>
        {
            Assert.That( _defaultTemplate, Is.Not.Null );
            Warn.If( insertedDefaultTemplate, Is.False );
            Assert.That( _defaultTemplate, Is.SameAs( _templatesDictionary[ "default" ] ) );
        } );
    }
    ...
    public void CreateChildTest_NoRecursion( )
    {
        ...
        Template newChildTemplate = _defaultTemplate.CreateChild( productionTemplateSection, _templatesDictionary, productionTemplateSection.Key, skipRecursion: true );
