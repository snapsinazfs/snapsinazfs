...
public record SnapsInAZfsZfsDataset( string Name, string Kind, bool IsPoolRoot )
{
    ...
    public ZfsProperty<string> Recursion { get; private set; } = new( ZfsPropertyNames.RecursionPropertyName, ZfsPropertyValueConstants.SnapsInAZfs, "local" );
